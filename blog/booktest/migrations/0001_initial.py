# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-10-29 02:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='booktest.BlogCategory', verbose_name='博客分类')),
            ],
            options={
                'verbose_name': '博客',
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(to='booktest.Tags', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
        ...
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booktest.Post', verbose_name='博客'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
